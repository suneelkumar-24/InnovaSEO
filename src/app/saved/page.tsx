  ...
  return (
    <div className="flex-1 flex flex-col bg-[#faf9f6] min-h-screen">
      ...
      <main className="flex-1 p-6 sm:p-8 max-w-7xl mx-auto w-full space-y-6">
        ...
        <div className="bg-white border border-purple-200/90 rounded-3xl p-5 sm:p-6 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-end">
            {/* Interval Selector */}
            <div className="flex items-center gap-2 bg-[#faf9f6] border border-slate-200 rounded-2xl px-3.5 py-2 text-xs text-slate-700">
            ...
            >
              <Radio className={`w-4 h-4 ${autoSyncEnabled ? 'text-purple-600 animate-pulse' : 'text-slate-400'}`} />
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      >
                        <RefreshCw
                          className={`w-4 h-4 ${isSingleCalculating ? 'animate-spin text-purple-600' : ''}`}
                        />
                      </button>
                  ...
                  <div>
                    <Link
                      ...
                      className="text-lg font-bold text-slate-900 hover:text-purple-600 transition flex items-center gap-2"
                    >
                      <span className="truncate">{niche.nicheName}</span>
                      <ExternalLink className="w-4 h-4 text-slate-400 opacity-0 group-hover:opacity-100 transition shrink-0" />
                    </Link>
                  ...
                  <div className="grid grid-cols-2 gap-3 bg-[#faf9f6] p-4 rounded-2xl border border-slate-200/80 text-xs">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {/* Delta Pill */}
                        {delta > 0 ? (
                          <span className="inline-flex items-center text-xs font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full border border-emerald-200">
                            <TrendingUp className="w-3 h-3 mr-1" />
                            +{delta}
                          </span>
                        ) : delta < 0 ? (
                          <span className="inline-flex items-center text-xs font-bold text-rose-700 bg-rose-100 px-2 py-0.5 rounded-full border border-rose-200">
                    ...
                    <div>
                      <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider">Verdict</span>
                      <span
